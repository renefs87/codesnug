...
from .models import CodesnugUser, UserProfile
from .forms import CodesnugUserAdminForm
...
class CodesnugUserAdmin(UserAdmin):
...
admin.site.register(CodesnugUser, CodesnugUserAdmin)
