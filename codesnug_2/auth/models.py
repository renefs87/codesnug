...
class CodesnugUserManager(UserManager):
    """
...
class UserProfile(models.Model):
    ...
    """
    user = models.OneToOneField(CodesnugUser, primary_key=True, verbose_name='user', related_name='profile')
