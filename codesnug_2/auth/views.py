...
from .forms import CodesnugUserEditForm
...
class CodesnugUserEditView(UpdateView):
    ...
    ``get_object`` method.
    """
    form_class = CodesnugUserEditForm
    ...
    def form_valid(self, form):
        ...
        return super(CodesnugUserEditView, self).form_valid(form)


account_profile = login_required(CodesnugUserEditView.as_view())
